...
from cyclo_lab.sim2real.runtime.reset_handler import ResetRequestHandler
from cyclo_lab.sim2real.runtime.sg2_bridge import SG2ZenohRos2Bridge
from cyclo_lab.sim2real.specs import ffw_sg2 as sg2_cfg
...
def run_simulator(
    ...
    publish_period = 1.0 / sg2_cfg.PUBLISH_HZ if sg2_cfg.PUBLISH_HZ > 0 else 0.0
...
def main(args_cli, simulation_app):
    ...
    sim_cfg = sim_utils.SimulationCfg(
        ...
        render_interval=sg2_cfg.RENDER_INTERVAL,
    )
    ...
    bridge = SG2ZenohRos2Bridge(
        ...
        cmd_vel_timeout=sg2_cfg.CMD_VEL_TIMEOUT,
